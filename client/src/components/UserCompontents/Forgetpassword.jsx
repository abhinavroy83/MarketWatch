    ...
    <div className="mt-[9rem] bg-white p-5 h-[500px] rounded-md border-t-2 border-b-2 border-black w-[850px] font-['udemy-regular'] flex self-center gap-10 items-center justify-center shadow-gray-300 shadow-lg">
      ...
      <div className="w-[370px] flex flex-col gap-3">
        ...
        <form onSubmit={handleSubmit(onsubmit)}>
          ...
          <button
            type="submit"
            className="rounded-md bg-red-500 mt-4 w-full p-2 text-[19px] font-semibold text-white shadow-sm shadow-[#ccc] hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Update Password
          </button>
        </form>
