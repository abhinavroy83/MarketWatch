...
function ChildContainer({ className, children, onLocationReceived }) {
  ...
  return (
    <div className={` w-full mt-36 h-full ${className}`}>
      <div className="flex justify-center w-full max-w-[1600px] w-full m-auto">
        ...
        <aside className="w-1/5 m-2 h-2/3 font-[Montserrat] mt-20 bg-gray-300 py-5 px-5">
            ...
            {weatherData ? (
              <div className="rounded-xl border-2 bg-gradient-to-t from-cyan-600 to-blue-800 text-white text-[30px] font-[Montserrat] shadow-sm shadow-[#000] p-2">
                ...
                <div className="flex w-full flex-wrap justify-space-between">
                  <div className="flex mt-5 text-white text-[40px] font-[OpenSans] gap-2">
                    <div>
                      {weatherData.weather &&
                  ...
                  <div className="mt-0 text-[26px] flex-grow text-center">
                    {weatherData.weather && (
                      <p>{weatherData.weather[0].main}</p>
                    )}
                    <article className="flex justify-center text-center gap-2 mt-2">
                      <img
          ...
          <div className="border-2 bg-white mt-4 rounded-md shadow-sm shadow-[#000]">
            <h1 className="text-lg text-black mt-5 ml-5 font-black">
              SEARCHES
            </h1>
            <div className="px-5">
              ...
              <ul>
                <li style={{ marginLeft: 0 }}>
                  <button
                    ...
                    className="rounded-md bg-transparent font-bold mt-1 text-md text-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Demo Search
                  </button>
                </li>
