...
function DashConatiner({ children }) {
  ...
  return (
    <div className="lg:mt-[9rem] mt-[11rem] mx-auto px-4 flex flex-col max-w-[1600px] h-auto w-full m-auto overflow-hidden font-['udemy-regular']">
      {alertstatus && (
        <div>
          {!isverified && (
            <div
      ...
      <div className="flex lg:flex-row flex-col">
        <div className="border-gray-300 border">
          ...
          >
            ...
            <div className="border  p-[1.6rem] mx-2 lg:mx-8 mt-0 lg:mt-4 items-center flex flex-col rounded-lg ">
        ...
        <main className="w-auto lg:w-4/5 h-auto border p-2 overflow-scroll">
          {children}
        </main>
      </div>
    </div>
