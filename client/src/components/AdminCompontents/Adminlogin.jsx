          ...
          />             */}
              <div className="justify-center">
                <div className="flex font-['udemy-regular']  items-center">
                  <label className="min-w-[130px] text-[20px] text-black">
                    User Name:
                  </label>
                  <input
                    className="flex h-15 font-['udemy-regular'] w-[300px] bg-black text-[19px] border-2 border-black/10 bg-transparent px-3 py-2 placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-40 "
                    type="text"
                    Placeholder="Username"
                    {...register("username", {
                ...
                <div className="flex font-['udemy-regular'] items-center mt-5">
                  ...
                  <input
                    className="flex h-15 font-['udemy-regular'] w-[300px] bg-white text-[19px] border-2 border-black/10 bg-transparent px-3 py-2 placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-40 "
                    type="text"
                    Placeholder="Password"
                    {...register("password", {
