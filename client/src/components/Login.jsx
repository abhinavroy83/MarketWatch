        ...
        <div className="w-50 mx-20 items-center">
          <h1 className="text-3xl font-bold text-[#17b19f] text-center">
            ...
            <Input  
              ...
              <h1 className="text-base mt-2 underline font-bold text-[#000] text-center">Or Continue With</h1>              
            <div>
                <button
                type="submit"
              ...
              ><svg class="h-5 w-5 text-gray-900" align-iteams="left" width="20" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M17.788 5.108A9 9 0 1021 12h-8" /></svg>
