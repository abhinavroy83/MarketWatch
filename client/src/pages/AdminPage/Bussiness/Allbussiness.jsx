  ...
  const fetchbussiness = async (city) => {
    try {
      const res = await axios.get(
        city
          ? `https://marketwatch-e3hc.onrender.comapi/admin/getallbussiness/${city}`
          : `https://marketwatch-e3hc.onrender.comapi/admin/getallbussiness`
      );
  ...
  const deleteuser = async (_id) => {
    try {
      const dlt = await axios.delete(
        `https://marketwatch-e3hc.onrender.comapi/admin/deletebusiness/${_id}`
      );
      if (dlt) {
