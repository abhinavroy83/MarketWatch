  ...
  const fetchrooms = async (city) => {
    try {
      const res = await axios.get(
        city
          ? ` http://api.verydesi.com/api/admin/getroombycity/${city}`
          : ` http://api.verydesi.com/api/admin/getallrooms`
      );
  ...
  const deleteuser = async (_id) => {
    try {
      const dlt = await axios.delete(
        ` http://api.verydesi.com/api/admin/deleteroom/${_id}`
      );
      if (dlt) {
          ...
          <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
            ...
            <div className="flex">
              ...
              <button
                ...
                className="flex rounded-md bg-green-800 px-3 py-2 text-[20px] font-semibold text-white shadow-sm hover:bg-green-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Add Room
              </button>
            </div>
