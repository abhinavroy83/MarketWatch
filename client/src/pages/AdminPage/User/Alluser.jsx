  ...
  const fetchuser = async () => {
    try {
      const res = await axios.get(
        "https://marketwatch-e3hc.onrender.comapi/admin/alluser"
      );
    ...
    try {
      ...
      if (role === "CustomerSupport") {
        ...
        const res = await axios.post(
          `https://marketwatch-e3hc.onrender.comapi/admin/createapproval`,
          { userId: _id },
          {
            headers: {
              jwttoken: `${token}`,
        ...
        const dlt = await axios.delete(
          `https://marketwatch-e3hc.onrender.comapi/admin/deleteuser/${_id}`
        );
        if (dlt) {
