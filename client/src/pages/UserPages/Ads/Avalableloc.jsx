...
function Avalableloc({ isOpen, onClose }) {
  ...
  return (
    <div className="flex flex-col absolute left-0 top-4 shadow-lg p-2 shadow-gray-700 mt-2 w-[400px] h-90 bg-white justify-center mx-auto font-['udemy-regular'] border-2 rounded-md border-black">
      {" "}
      {/* <RxCross1
