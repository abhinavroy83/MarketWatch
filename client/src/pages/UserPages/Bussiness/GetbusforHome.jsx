  ...
  const fetchBusiness = async () => {
    try {
      const res = await axios.get(
        usercity
          ? `https://marketwatch-e3hc.onrender.comapi/getbusinessbyloc?city=${usercity}`
          : `https://marketwatch-e3hc.onrender.comapi/getbusinessbyloc?lat=${currentloc.lat}&lng=${currentloc.lng}`
      );
