...
function Rooms() {
  ...
  const fetchroomdetails = async () => {
    try {
      const res = await axios.get(
        `https://marketwatch-e3hc.onrender.comapi/getspecificroom/${_id}`
      );
  ...
  const getRooms = async () => {
    try {
      const res = await axios.get(
        `https://marketwatch-e3hc.onrender.comapi/getallrooms?lat=${currentloc.lng}&lng=${currentloc.lat}`
      );
  ...
  const fetchNextRoom = async () => {
    try {
      const res = await axios.get(
        `https://marketwatch-e3hc.onrender.comapi/rooms/${_id}/previous`
      );
      // console.log(res);
  ...
  const fetchPreviousRoom = async () => {
    try {
      const res = await axios.get(
        `https://marketwatch-e3hc.onrender.comapi/rooms/${_id}/next`
      );
      // console.log(res);
...
{/* <div className="flex">
  ...
  useEffect(() => {
    const fetchwishstatus = async () => {
      try {
        const res = await axios.get(
          `https://marketwatch-e3hc.onrender.comapi/getlistbyroom/${_id}`
        );
