  ...
  return (
    <ChildContainer onLocationReceived={locationsndString}>
      <div className="px-2 py-2 font-[opensans] mt-10 md:px-6 md:py-10 text-[36px]">
        <h1 className="text-3xl font-bold capitalize text-black lg:text-4xl text-[36px]">
        ...
        <article className="flex gap-2 items-center mt-6 ml-2">
            ...
            <article className="flex gap-2 items-center mt-2 ml-2">
             ...
             <svg class="h-6 w-6 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <line x1="12" y1="5" x2="12" y2="19" />  <line x1="18" y1="11" x2="12" y2="5" />  <line x1="6" y1="11" x2="12" y2="5" /></svg> 232
            </button>
              <p className="text-lg font-semibold text-black font-[OpenSans]">
                $550 
              </p>
